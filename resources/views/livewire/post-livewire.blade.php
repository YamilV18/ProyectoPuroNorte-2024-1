...
<div>
    <nav x-data="{ open: false }" class=" bg-gradient-to-r from-black via-orange-900 to-black ...">
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-shrink-0 items-center">
                <img class="h-10 w-auto" src="./../img/logo.png" alt="Puro Norte">
              </div>
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="hidden sm:ml-6 sm:block">
                ...
                <div class="flex space-x-4">
                  ...
                  <a href="" class="text-white md:font-bold hover:bg-orange-700  hover:text-white rounded-md px-3 py-2 text-sm font-medium">CARTA</a>
                  ...
                  <a href="dashboard"class="text-white md:font-bold hover:bg-orange-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">DASHBOARD</a>
                </div>
              </div>
            </div>
                ...
                <div class=" p-6 text-right z-10">
                    @auth
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="text-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                                SALIR
                            </button>
                        </form>
                    @else
                        <a href="{{ route('login') }}" class="text-white md:font-bold hover:bg-orange-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            INGRESAR
                        </a>
                    @endauth
                </div>
        ...
        <div x-show="open" @click.outside="open=false" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 px-2 pb-3 pt-2">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="/" class="hover:bg-orange-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">INICIO</a>
            <a href="#" class="text-gray-300 hover:bg-orange-900 hover:text-white block rounded-md px-3 py-2 text-base font-medium">CARTA</a>
            <a href="#" class="text-gray-300 hover:bg-orange-900 hover:text-white block rounded-md px-3 py-2 text-base font-medium">PROMOCIONES</a>
        </div>
      </nav>
...
<div
class="relative h-[600px] overflow-hidden bg-[url('https://origin.cronosmedia.glr.pe/large/2022/04/20/lg_62609618295ab512e274b8f3.jpg')] bg-cover bg-[50%] bg-no-repeat">
<div
  class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-black/60 bg-fixed">
  <div class="flex h-full items-center justify-center">
    <div class="px-6 text-center text-white md:px-12">
        <h1 class="mb-6 text-5xl font-extrabold tracking-tight uppercase">PURO NORTE</h1>
        <h3 class="mb-8 text-3xl font-semibold">¡Disfruta de nuestros deliciosos anticuchos y saborea la tradición en cada mordisco en nuestra anticucheria!</h3>
...
<footer>
    <!--Footer container-->
<footer
class="flex flex-col items-center bg-zinc-50 text-center text-surface bg-gradient-to-r from-black to-black ... dark:text-white">
<div class="container p-6">
  <div class="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
    <div class="mb-6 lg:mb-0">
      <img
        src="https://www.shutterstock.com/image-photo/anticucho-de-typical-dish-peruvian-600nw-2206455669.jpg"
        class="w-full rounded-md shadow-lg" />
    </div>
    <div class="mb-6 lg:mb-0">
      <img
        src="https://www.shutterstock.com/image-photo/peruvian-anticuchos-juicy-seasoned-fresh-600nw-2421858845.jpg"
        class="w-full rounded-md shadow-lg" />
    </div>
    <div class="mb-6 lg:mb-0">
      <img
        src="https://www.shutterstock.com/image-photo/cooking-typical-peruvian-food-anticuchos-600nw-2440246351.jpg"
        class="w-full rounded-md shadow-lg" />
    </div>
    <div class="mb-6 lg:mb-0">
      <img
        src="https://www.miscostillitas.com/inicio/wp-content/uploads/2022/03/NTICUCHOS.jpg"
        class="w-full rounded-md shadow-lg" />
    </div>
    <div class="mb-6 lg:mb-0">
      <img
        src="https://cdn.tasteatlas.com/images/dishes/d8823aa438234b9e989dbba23bbb5649.jpg?w=600"
        class="w-full rounded-md shadow-lg" />
    </div>
    <div class="mb-6 lg:mb-0">
      <img
        src="https://www.shutterstock.com/image-photo/peruvian-anticuchos-cuts-cows-heart-600nw-1690217269.jpg"
        class="w-full rounded-md shadow-lg" />
    </div>
  </div>
</div>
